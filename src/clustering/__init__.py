...
CLUSTERING_DICT = {"sr_fca": SRFCA, "ifca": IFCA, "cfl": CFL, "fedavg": FedAvg, "oneshot_kmeans": OneShotKMeans, "soft_ifca": SoftIFCA, "oneshot_ifca" : OneShotIFCA, "feddrift": FedDrift}
