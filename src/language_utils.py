...
"""Downloaded from https://github.com/TalwalkarLab/leaf/blob/master/models/utils/language_utils.py"""
...
def letter_to_vec(letter):
    '''returns one-hot representation of given letter
        update : returns index of representation of given letter
    '''
...
def letter_to_index(letter):
    '''returns a int of character index
    Args:
        letter: a character
